...
- Updated dev dependencies to address security vulnerabilities (vite, vitest, rollup, picomatch)

## [1.2.2] - 2026-01-19

### Changed

- Added `.npmignore` to exclude TypeScript source files and `src` directory from npm package

## [1.2.1] - 2026-01-19

### Changed

- `src` directory removed from package files to reduce package size
